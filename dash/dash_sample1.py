...
def update_figure(selected_number):
    ...
    x = [r_data[selected_number]]
    y = [e_data[selected_number]]
...
def update_p_figure(selected_number):
    x = r_data[0:selected_number]
    #print(type(x))
    #data = [dict(x=x,type='Histogram')]
    data = [go.Histogram(x=x,nbinsx=1000, histnorm='probability density',opacity=0.5)]
    #print(data)
    #print(data)
    #print(data)
    x_1 = np.arange(0,10,0.001)
